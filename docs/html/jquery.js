...
!function(e, t) {
    ...
    var d = function(n) {
                ...
                se.uniqueSort =
                    function(e) {
                        ...
                        if (l = !d.detectDuplicates,
                            u = !d.sortStable && e.slice(0), e.sort(j), l) {
        ...
        function Ee(e) {
            for (var i, t, n,
                 r = e.length, o = b.relative[e[0].type],
            ...
            if (r[1]) {
                if (t = t instanceof S ? t[0] : t,
                    S.merge(
                        this,
                        S.parseHTML(
                            r[1], t && t.nodeType ? t.ownerDocument || t : E,
                            !0)),
            ...
            handler: function(e) {
                ...
                if (1 & e.isTrigger && this[i]) {
                    if (r.length)
                        ...
                        r = s.call(arguments), Y.set(this, i, r),
                        t = o(this, i), this[i](),
                    ...
                    r.length &&
                        (Y.set(this, i, {
                            value: S.event.trigger(
                                S.extend(r[0], S.Event.prototype), r.slice(1),
                                this)
                        }),
    ...
    function He(n, r, i, o) {
        ...
        if (f &&
            ...
            for (s = (a = S.map(ve(e, 'script'), De)).length; c < f; c++)
                ...
                i.call(n[c], u, c);
            if (s)
                for (l = a[a.length - 1].ownerDocument, S.map(a, qe), c = 0;
                     c < s; c++)
                    u = a[c],
                 ...
                 reliableTrDimensions: function() {
                     ...
                     return null == a &&
                                (e = E.createElement('table'),
                                 ...
                                 re.appendChild(e).appendChild(t).appendChild(
                                     n),
    ...
    function lt(o, e, t) {
        var n, a,
            ...
            l = s.promise({
                ...
                props: S.extend({}, e),
                opts: S.extend(
                    !0, {specialEasing: {}, easing: S.easing._default}, t),
    ...
    S.Animation = S.extend(lt, {
        ...
        prefilters: [function(e, t, n) {
            var r, i, o, a, s, u, l, c,
                f = 'width' in t || 'height' in t, p = this, d = {},
        ...
        stop: function(i, e, o) {
            ...
            return 'string' != typeof i && (o = e, e = i, i = void 0),
                   e && this.queue(i || 'fx', []), this.each(function() {
                       var e = !0, t = null != i && i + 'queueHooks',
                           n = S.timers, r = Y.get(this);
                       if (t)
                           r[t] && r[t].stop && a(r[t]);
                       else
                           for (t in r)
        ...
        S.extend({
            valHooks: {
                ...
                select: {
                    ...
                    set: function(e, t) {
                        var n, r, i = e.options, o = S.makeArray(t),
                                  a = i.length;
                        while (a--)
                            ((r = i[a]).selected =
    ...
    Mt.href = bt.href, S.extend({
        ...
        ajax: function(e, t) {
            ...
            if (x.promise(T),
                v.url = ((e || v.url || bt.href) +
                         '').replace(Ht, bt.protocol + '//'),
                v.type = t.method || t.type || v.method || v.type,
                v.dataTypes =
                    (v.dataType || '*').toLowerCase().match(P) || [''],
                null == v.crossDomain) {
                r = E.createElement('a');
                try {
                    r.href = v.url, r.href = r.href,
                    v.crossDomain = Mt.protocol + '//' + Mt.host !=
                        r.protocol + '//' + r.host
                } catch (e) {
                    v.crossDomain = !0
                }
        ...
        if (y.cors || $t && !i.crossDomain) return {
                send: function(e, t) {
                    ...
                    o =
                        ...
                        return function() {
                            o &&
                                (o = a = r.onload = r.onerror = r.onabort =
    ...
    S.ajaxSetup({
        ...
        S.offset = {
            setOffset: function(e, t, n) {
                var r, i, o, a, s, u, l = S.css(e, 'position'), c = S(e),
                                      f = {};
                ...
                S.fn[t] = function(e) {
                    return $(this, function(e, t, n) {
                        ...
                        if (x(e) ? r = e :
                            ...
                            return r ? r[i] : e[t];
                        r ? r.scrollTo(
                                o ? r.pageXOffset : n, o ? n : r.pageYOffset) :
                            e[t] = n
...
!function(t) {
        ...
        (n = y.cleanData,
         function(t) {
             for (var e, i, s = 0; null != (i = t[s]); s++)
                 (e = y._data(i, 'events')) && e.remove &&
                     y(i).triggerHandler('remove');
             n(t)
         }),
    y.widget =
        function(t, i, e) {
        var s, n, o, h = {}, a = t.split('.')[0],
                     r = a + '-' + (t = t.split('.')[1]);
        return e || (e = i, i = y.Widget),
               Array.isArray(e) && (e = y.extend.apply(null, [{}].concat(e))),
               y.expr.pseudos[r.toLowerCase()] =
                   function(t) {
                   return !!y.data(t, r)
               },
               y[a] = y[a] || {}, s = y[a][t],
               ...
               y.each(
                   ...
                   function(e, s) {
                       ...
                       h[e] = 'function' == typeof s ? function() {
                           ...
                           return this._super = n, this._superApply = o,
                                  t = s.apply(this, arguments), this._super = e,
                                  this._superApply = i, t
                       } : s
                   }),
               n.prototype = y.widget.extend(
                   o, {widgetEventPrefix: s && o.widgetEventPrefix || t}, h, {
                       constructor: n,
                       namespace: a,
                       widgetName: t,
                       widgetFullName: r
               ...
               s ? (y.each(
                        s._childConstructors,
                        function(t, e) {
                            var i = e.prototype;
                            y.widget(
                                i.namespace + '.' + i.widgetName, n, e._proto)
                        }),
                    delete s._childConstructors) :
                   i._childConstructors.push(n),
               y.widget.bridge(t, n), n
    },
    y.widget.extend =
        function(t) {
        for (var e, i, s = a.call(arguments, 1), n = 0, o = s.length; n < o;
             n++)
            for (e in s[n])
                i = s[n][e],
                h.call(s[n], e) && void 0 !== i &&
                    (y.isPlainObject(i) ? t[e] = y.isPlainObject(t[e]) ?
    ...
    y.widget.bridge =
        ...
        y.fn[o] = function(i) {
            var t = 'string' == typeof i, s = a.call(arguments, 1), n = this;
            return t ? this.length || 'instance' !== i ? this.each(function() {
                ...
                return 'instance' === i ?
                    ...
                    y.error(
                        'no such method \'' + i + '\' for ' + o +
                        ' widget instance') :
                        (t = e[i].apply(e, s)) !== e && void 0 !== t ?
                    (n = t && t.jquery ? n.pushStack(t.get()) : t, !1) :
                    void 0 :
                    y.error(
                        'cannot call methods on ' + o +
                        ' prior to initialization; attempted to call method \'' +
                        i + '\'')
            }) :
                                                         n = void 0 :
                                                         (s.length &&
                            (i = y.widget.extend.apply(null, [i].concat(s))),
                        this.each(function() {
                            var t = y.data(this, h);
                            t ? (t.option(i || {}), t._init && t._init()) :
                                                                  y.data(this, h, new e(i, this))
                        })),
                                                         n
        }
    },
    y.Widget = function() {}, y.Widget._childConstructors = [],
    y.Widget.prototype = {
        widgetName: 'widget',
        widgetEventPrefix: '',
        defaultElement: '<div>',
        ...
        _createWidget: function(t, e) {
            e = y(e || this.defaultElement || this)[0], this.element = y(e),
            this.uuid = i++,
            this.eventNamespace = '.' + this.widgetName + this.uuid,
            this.bindings = y(), this.hoverable = y(), this.focusable = y(),
            ...
            e !== this &&
                (y.data(e, this.widgetFullName, this),
                 ...
                 this.window =
                     y(this.document[0].defaultView ||
                       this.document[0].parentWindow)),
            this.options =
                y.widget.extend({}, this.options, this._getCreateOptions(), t),
            this._create(),
        ...
        option: function(t, e) {
            ...
            if ('string' == typeof t)
                if (o = {}, t = (i = t.split('.')).shift(), i.length) {
                    for (s = o[t] = y.widget.extend({}, this.options[t]), n = 0;
                         n < i.length - 1; n++)
                        s[i[n]] = s[i[n]] || {}, s = s[i[n]];
                    ...
                    if (1 === arguments.length)
                        return void 0 === this.options[t] ? null :
                                                            this.options[t];
                    o[t] = e
                }
        ...
        _setOptionClasses: function(t) {
            ...
            for (e in t)
                ...
                t[e] !== this.options.classes[e] && s && s.length &&
                    (i = y(s.get()), this._removeClass(s, e),
                     i.addClass(this._classes(
                         {element: i, keys: e, classes: t, add: !0})))
        },
        ...
        _classes: function(n) {
            ...
            function t(t, e) {
                for (var i, s = 0; s < t.length; s++)
                    ...
                    h.classesElementLookup[t[s]] = i, o.push(t[s]),
            ...
            return (n = y.extend(
                   ...
                   n.extra && t(n.extra.match(/\S+/g) || []), o.join(' ')
        },
        ...
        _on: function(n, o, t) {
            ...
            'boolean' != typeof n && (t = o, o = n, n = !1),
                t ? (o = h = y(o), this.bindings = this.bindings.add(o)) :
        ...
        _off: function(t, e) {
            e = (e || '').split(' ').join(this.eventNamespace + ' ') +
                this.eventNamespace,
            t.off(e), this.bindings = y(this.bindings.not(t).get()),
        ...
        _hoverable: function(t) {
            this.hoverable = this.hoverable.add(t), this._on(t, {
                ...
                mouseleave: function(t) {
                    this._removeClass(
                        y(t.currentTarget), null, 'ui-state-hover')
                }
            })
        },
        _focusable: function(t) {
            this.focusable = this.focusable.add(t), this._on(t, {
                ...
                focusout: function(t) {
                    this._removeClass(
                        y(t.currentTarget), null, 'ui-state-focus')
                }
            })
        },
            ...
            if (i = i || {},
                (e = y.Event(e)).type =
                    (t === this.widgetEventPrefix ? t :
                        ...
                        .toLowerCase(),
                e.target = this.element[0], n = e.originalEvent)
    ...
    y.each({show: 'fadeIn', hide: 'fadeOut'}, function(o, h) {
        y.Widget.prototype['_' + o] = function(e, t, i) {
            ...
            'number' == typeof (t = t || {}) ?
                t = {duration: t} :
                !0 === t && (t = {}),
                s = !y.isEmptyObject(t), t.complete = i,
                t.delay && e.delay(t.delay),
                s && y.effects && y.effects.effect[n] ? e[o](t) :
                n !== o && e[n] ? e[n](t.duration, t.easing, i) :
                                  e.queue(function(t) {
    ...
    x = Math.max, D = Math.abs, o = /left|center|right/,
    r = /top|center|bottom/, l = /[\+\-]\d+(\.[\d]+)?%?/, u = /^\w+/, p = /%$/,
    W = y.fn.position, y.position = {
        scrollbarWidth: function() {
            ...
            return y('body').append(e),
                   t = i.offsetWidth, e.css('overflow', 'scroll'),
                   t === (i = i.offsetWidth) && (i = e[0].clientWidth),
                   e.remove(), s = t - i
        },
        getScrollInfo: function(t) {
            var e = t.isWindow || t.isDocument ? '' :
                                                 t.element.css('overflow-x'),
                i = t.isWindow || t.isDocument ? '' :
        ...
        getWithinInfo: function(t) {
            var e = y(t || window), i = S(e[0]),
                s = !!e[0] && 9 === e[0].nodeType;
            return {
                element: e, isWindow: i, isDocument: s,
    ...
    y.fn.position = function(p) {
        ...
        return _[0].preventDefault && (p.at = 'left top'),
               c = e.width, f = e.height, m = y.extend({}, g = e.offset),
               y.each(
                   ['my', 'at'],
                   function() {
                       var t, e, i = (p[this] || '').split(' ');
                       (i = 1 === i.length ?
                            o.test(i[0])     ? i.concat(['center']) :
                                r.test(i[0]) ? ['center'].concat(i) :
                                               ['center', 'center'] :
                            i)[0] = o.test(i[0]) ? i[0] : 'center',
                            i[1] = r.test(i[1]) ? i[1] : 'center',
                            t = l.exec(i[0]), e = l.exec(i[1]),
                            z[this] = [t ? t[0] : 0, e ? e[0] : 0],
                            p[this] = [u.exec(i[0])[0], u.exec(i[1])[0]]
                   }),
               1 === b.length && (b[1] = b[0]),
               'right' === p.at[0] ? m.left += c :
                                     'center' === p.at[0] && (m.left += c / 2),
               'bottom' === p.at[1] ? m.top += f :
                                      'center' === p.at[1] && (m.top += f / 2),
               d = E(z.at, c, f), m.left += d[0], m.top += d[1],
               this.each(function() {
                   var i, t, h = y(this), a = h.outerWidth(),
                             r = h.outerHeight(), e = H(this, 'marginLeft'),
                             s = H(this, 'marginTop'),
                   ...
                   'right' === p.my[0] ?
                       ...
                       p.using && (t = function(t) {
                           var e = g.left - l.left, i = e + c - a,
                               s = g.top - l.top, n = s + f - r, o = {
                                   target: {
                                       element: _,
                                       left: g.left,
                                       top: g.top,
        ...
        fit: {
            left: function(t, e) {
                var i = e.within, s = i.isWindow ? i.scrollLeft : i.offset.left,
                    n = i.width, o = t.left - e.collisionPosition.marginLeft,
                    h = s - o, a = o + e.collisionWidth - n - s;
                e.collisionWidth > n ?
                    0 < h && a <= 0 ?
                    (i = t.left + h + e.collisionWidth - n - s,
                     t.left += h - i) :
                    t.left = !(0 < a && h <= 0)&& a < h ?
            ...
            top: function(t, e) {
                var i = e.within, s = i.isWindow ? i.scrollTop : i.offset.top,
                    n = e.within.height,
                    o = t.top - e.collisionPosition.marginTop, h = s - o,
                    a = o + e.collisionHeight - n - s;
                e.collisionHeight > n ?
                    0 < h && a <= 0 ?
                    (i = t.top + h + e.collisionHeight - n - s,
                     t.top += h - i) :
                    t.top = !(0 < a && h <= 0)&& a < h ?
        ...
        flip: {
            left: function(t, e) {
                var i = e.within, s = i.offset.left + i.scrollLeft, n = i.width,
                    ...
                    h = t.left - e.collisionPosition.marginLeft, a = h - o,
                    r = h + e.collisionWidth - n - o,
                    l = 'left' === e.my[0] ? -e.elemWidth :
                    'right' === e.my[0]    ? e.elemWidth :
                                             0,
                    i = 'left' === e.at[0] ? e.targetWidth :
                ...
                a < 0 ?
                    ((s = t.left + l + i + h + e.collisionWidth - n - s) < 0 ||
                     s < D(a)) &&
                        (t.left += l + i + h) :
                    0 < r &&
                        (0 < (o = t.left - e.collisionPosition.marginLeft + l +
                                  i + h - o) ||
                         D(o) < r) &&
                        (t.left += l + i + h)
            },
            top: function(t, e) {
                var i = e.within, s = i.offset.top + i.scrollTop, n = i.height,
                    ...
                    h = t.top - e.collisionPosition.marginTop, a = h - o,
                    r = h + e.collisionHeight - n - o,
                    l = 'top' === e.my[1] ? -e.elemHeight :
                    'bottom' === e.my[1]  ? e.elemHeight :
                                            0,
                    i = 'top' === e.at[1] ? e.targetHeight :
                ...
                a < 0 ?
                    ((s = t.top + l + i + h + e.collisionHeight - n - s) < 0 ||
                     s < D(a)) &&
                        (t.top += l + i + h) :
                    0 < r &&
                        (0 < (o = t.top - e.collisionPosition.marginTop + l +
                                  i + h - o) ||
                         D(o) < r) &&
                        (t.top += l + i + h)
            }
    ...
    y.ui.position, y.extend(y.expr.pseudos, {
        ...
        y.fn.extend({
            disableSelection:
                (t = 'onselectstart' in document.createElement('div') ?
                     'selectstart' :
                     'mousedown',
                 function() {
    ...
    y.ui.focusable = function(t, e) {
        ...
        return 'area' === h ?
            ...
            (/^(input|select|textarea|button|object)$/.test(h) ?
                 (n = !t.disabled) && (o = y(t).closest('fieldset')[0]) &&
                     (n = !o.disabled) :
                 n = 'a' === h && t.href || e,
        ...
        _unbindFormResetHandler: function() {
            ...
            this.form.length &&
                ((t = this.form.data('ui-form-reset-instances'))
                     .splice(y.inArray(this, t), 1),
                 t.length ? this.form.data('ui-form-reset-instances', t) :
    ...
    y.fn.labels =
        ...
        return this.length ?
            ...
            (e = this.eq(0).parents('label'),
             (t = this.attr('id')) &&
                 (i = (i = this.eq(0).parents().last())
                          .add((i.length ? i : this).siblings()),
    ...
    y.fn.scrollParent =
        function(t) {
        var e = this.css('position'), i = 'absolute' === e,
            ...
            t = this.parents()
                    .filter(function() {
                        ...
                        return (!i || 'static' !== t.css('position')) &&
                            s.test(
                                t.css('overflow') + t.css('overflow-y') +
                                t.css('overflow-x'))
                    })
                    .eq(0);
        return 'fixed' !== e && t.length ? t :
                                           y(this[0].ownerDocument || document)
    },
    y.extend(y.expr.pseudos, {
        tabbable: function(t) {
            var e = y.attr(t, 'tabindex'), i = null != e;
    ...
    y.widget('ui.mouse', {
            ...
            this.element
                ...
                .on('click.' + this.widgetName,
                    function(t) {
                        if (!0 ===
                            y.data(
                                t.target, e.widgetName + '.preventClickEvent'))
                            return y.removeData(
                                       t.target,
        ...
        _mouseDown: function(t) {
            if (!f) {
                this._mouseMoved = !1, this._mouseStarted && this._mouseUp(t),
                this._mouseDownEvent = t;
                var e = this, i = 1 === t.which,
                    s = !('string' != typeof this.options.cancel ||
                          !t.target.nodeName) &&
        ...
        _mouseMove: function(t) {
            if (this._mouseMoved) {
                ...
                if (!t.which)
                    if (t.originalEvent.altKey || t.originalEvent.ctrlKey ||
                        t.originalEvent.metaKey || t.originalEvent.shiftKey)
            ...
            this.document
                ...
                (this._mouseStarted = !1,
                 t.target === this._mouseDownEvent.target &&
                     y.data(
                         t.target, this.widgetName + '.preventClickEvent', !0),
                 this._mouseStop(t)),
                this._mouseDelayTimer &&
                (clearTimeout(this._mouseDelayTimer),
                 delete this._mouseDelayTimer),
                this.ignoreMissingWhich = !1, f = !1, t.preventDefault()
        },
    ...
    y.widget('ui.resizable', y.ui.mouse, {
        ...
        _create: function() {
            ...
            this._addClass('ui-resizable'), y.extend(this, {
                ...
                _helper: e.helper || e.ghost || e.animate ?
                ...
                (this.element.wrap(y('<div class=\'ui-wrapper\'></div>').css({
                 ...
                 this.element.css(t), this.originalElement.css('margin', 0),
        ...
        _destroy: function() {
            ...
            function t(t) {
                y(t).removeData('resizable')
                    .removeData('ui-resizable')
                    .off('.resizable')
            }
            var e;
            return this.elementIsWrapper &&
                       (t(this.element), e = this.element,
            ...
            if (this.handles = o.handles ||
                    (y('.ui-resizable-handle', this.element).length ? {
                                   ...
                                   nw: '.ui-resizable-nw'
                                                                      ...
                                                                      'e,s,se'),
                this._handles = y(), this._addedHandles = y(),
                this.handles.constructor === String)
                for ('all' === this.handles &&
                         (this.handles = 'n,e,s,w,se,sw,ne,nw'),
                     i = this.handles.split(','), this.handles = {}, e = 0;
                     e < i.length; e++)
                    s = 'ui-resizable-' +
            ...
            this._renderAxis =
                ...
                for (e in t = t || this.element, this.handles)
                    this.handles[e].constructor === String ?
                        this.handles[e] = this.element.children(this.handles[e])
                                              .first()
                                              .show() :
                        (this.handles[e].jquery || this.handles[e].nodeType) &&
                            (this.handles[e] = y(this.handles[e]),
                             this._on(
                                 this.handles[e], {mousedown: h._mouseDown})),
                        this.elementIsWrapper &&
                        this.originalElement[0].nodeName.match(
                            /^(textarea|input|select|button)$/i) &&
                        (i = y(this.handles[e], this.element),
                         s = /sw|ne|nw|se|n|s/.test(e) ? i.outerHeight() :
                                                         i.outerWidth(),
                         i =
                             [
                                 'padding',
                                 /ne|nw|n/.test(e)     ? 'Top' :
                                     /se|sw|s/.test(e) ? 'Bottom' :
                                     /^e$/.test(e)     ? 'Right' :
                                                         'Left'
                             ].join(''),
        ...
        _mouseStart: function(t) {
            ...
            return this.resizing = !0, this._renderProxy(),
                   ...
                   this.aspectRatio = 'number' == typeof s.aspectRatio ?
                       s.aspectRatio :
                       this.originalSize.width / this.originalSize.height || 1,
                   s = y('.ui-resizable-' + this.axis).css('cursor'),
                   y('body').css(
                       'cursor', 'auto' === s ? this.axis + '-resize' : s),
                   this._addClass('ui-resizable-resizing'),
                   this._propagate('start', t), !0
        },
        _mouseDrag: function(t) {
            var e = this.originalMousePosition, i = this.axis,
                s = t.pageX - e.left || 0, e = t.pageY - e.top || 0,
                i = this._change[i];
            return this._updatePrevProperties(),
                   i &&
                       (e = i.apply(this, [t, s, e]),
                        ...
                        e = this._respectSize(e, t), this._updateCache(e),
                        this._propagate('resize', t), e = this._applyChanges(),
                        !this._helper &&
        ...
        _mouseStop: function(t) {
            ...
            return this._helper &&
                       (s = (e = (i = this._proportionallyResizeElements)
                                     .length &&
                        ...
                        i = parseFloat(o.element.css('left')) +
                                (o.position.left - o.originalPosition.left) ||
                            null,
                        s = parseFloat(o.element.css('top')) +
                                (o.position.top - o.originalPosition.top) ||
                            null,
                        n.animate ||
                            this.element.css(y.extend(e, {top: s, left: i})),
                        o.helper.height(o.size.height),
                        o.helper.width(o.size.width),
                        this._helper && !n.animate &&
                            this._proportionallyResize()),
        ...
        _respectSize: function(t) {
            var e = this._vBoundaries, i = this.axis,
                s = this._isNumber(t.width) && e.maxWidth &&
                e.maxWidth < t.width,
                n = this._isNumber(t.height) && e.maxHeight &&
                e.maxHeight < t.height,
                o = this._isNumber(t.width) && e.minWidth &&
                e.minWidth > t.width,
                h = this._isNumber(t.height) && e.minHeight &&
                e.minHeight > t.height,
                a = this.originalPosition.left + this.originalSize.width,
                r = this.originalPosition.top + this.originalSize.height,
                l = /sw|nw|w/.test(i), i = /nw|ne|n/.test(i);
            return o && (t.width = e.minWidth), h && (t.height = e.minHeight),
                   ...
                   t.width || t.height || t.left || !t.top ? t.width ||
                           t.height || t.top || !t.left || (t.left = null) :
                                                             t.top = null,
                                                             t
        },
        ...
        _proportionallyResize: function() {
            if (this._proportionallyResizeElements.length)
                for (var t, e = 0, i = this.helper || this.element;
                     e < this._proportionallyResizeElements.length; e++)
        ...
        _change: {
            ...
            w: function(t, e) {
                ...
                return {
                    left: this.originalPosition.left + e, width: i.width - e
                }
            },
            n: function(t, e, i) {
                var s = this.originalSize;
                return {
                    top: this.originalPosition.top + i, height: s.height - i
                }
            },
            s: function(t, e, i) {
                return {
                ...
                i.element.animate(
                    y.extend(n, o && h ? {top: o, left: h} : {}), {
                        ...
                        step: function() {
                            ...
                            s && s.length &&
                                y(s[0]).css({width: t.width, height: t.height}),
        ...
        y.ui.plugin.add('resizable', 'containment', {
            start: function() {
                var i, s, n = y(this).resizable('instance'), t = n.options,
                          e = n.element, o = t.containment,
                          h = o instanceof y ? o.get(0) :
                    /parent/.test(o)         ? e.parent().get(0) :
                                               o;
                h &&
                    (n.containerElement = y(h),
                     /document/.test(o) || o === document ?
                         ...
                         (i = y(h), s = [], y([
                          ...
                          t = n.containerOffset, e = n.containerSize.height,
            ...
            resize: function(t) {
                var e = y(this).resizable('instance'), i = e.options,
                    s = e.containerOffset, n = e.position,
                    o = e._aspectRatio || t.shiftKey, h = {top: 0, left: 0},
                    a = e.containerElement, t = !0;
                a[0] !== document && /static/.test(a.css('position')) &&
                    (h = s),
                    n.left < (e._helper ? s.left : 0) &&
                    (e.size.width = e.size.width +
                         (e._helper ? e.position.left - s.left :
                    ...
                    n = Math.abs(
                        e.sizeDiff.width +
                        (e._helper ? e.offset.left - h.left :
                                     e.offset.left - s.left)),
                    s = Math.abs(
                        e.sizeDiff.height +
                        (e._helper ? e.offset.top - h.top :
                                     e.offset.top - s.top)),
            ...
            stop: function() {
                var t = y(this).resizable('instance'), e = t.options,
                    i = t.containerOffset, s = t.containerPosition,
                    n = t.containerElement, o = y(t.helper), h = o.offset(),
                    a = o.outerWidth() - t.sizeDiff.width,
                    o = o.outerHeight() - t.sizeDiff.height;
                t._helper && !e.animate && /relative/.test(n.css('position')) &&
                    y(this).css(
                        {left: h.left - s.left - i.left, width: a, height: o}),
                    t._helper && !e.animate &&
        ...
        y.ui.plugin.add('resizable', 'alsoResize', {
            ...
            resize: function(t, i) {
                var e = y(this).resizable('instance'), s = e.options,
                    n = e.originalSize, o = e.originalPosition, h = {
                ...
                y(s.alsoResize).each(function() {
                    var t = y(this),
                        s = y(this).data('ui-resizable-alsoresize'), n = {},
        ...
        y.ui.plugin.add('resizable', 'ghost', {
            start: function() {
                var t = y(this).resizable('instance'), e = t.size;
                ...
                !1 !== y.uiBackCompat && 'string' == typeof t.options.ghost &&
...
$.fn.scrollTo = function(a, d, b) {
    ...
    return this.each(function() {
        ...
        if (null !== a) {
            var l = n(this), q = l ? this.contentWindow || window : this,
                r = $(q), e = a, f = {}, t;
            switch (typeof e) {
                case 'number':
                case 'string':
                ...
                t ? (f[g] = t[m] + (l ? 0 : h - r.offset()[m]),
                     b.margin &&
                         (f[g] -= parseInt(e.css('margin' + d), 10) || 0,
                          f[g] -=
                          parseInt(e.css('border' + d + 'Width'), 10) || 0),
                     f[g] += v[m] || 0,
                     b.over[m] &&
                         (f[g] +=
                          e['x' === c ? 'width' : 'height']() * b.over[m])) :
                    (d = e[m],
...
var DATA_DISPLAYCONTROLLER = 'displayController',
    DATA_HASACTIVEHOVER = 'hasActiveHover', DATA_FORCEDOPEN = 'forcedOpen',
    DATA_HASMOUSEMOVE = 'hasMouseMove', DATA_MOUSEONTOTIP = 'mouseOnToPopup',
    DATA_ORIGINALTITLE = 'originalTitle', DATA_POWERTIP = 'powertip',
    DATA_POWERTIPJQ = 'powertipjq', DATA_POWERTIPTARGET = 'powertiptarget',
    EVENT_NAMESPACE = '.powertip', RAD2DEG = 180 / Math.PI, MOUSE_EVENTS = [
...
$.fn.powerTip = function(opts, arg) {
    ...
    targetElements.each(function elementSetup() {
        var $this = $(this), dataPowertip = $this.data(DATA_POWERTIP),
    ...
    if (!options.manual) {
        $.each(options.openEvents, function(idx, evt) {
            if ($.inArray(evt, options.closeEvents) > -1) {
                targetElements.on(
                    evt + EVENT_NAMESPACE, function elementToggle(event) {
                        $.powerTip.toggle(this, event)
                    })
            } else {
                targetElements.on(
                    evt + EVENT_NAMESPACE, function elementOpen(event) {
        ...
        $.each(options.closeEvents, function(idx, evt) {
            if ($.inArray(evt, options.openEvents) < 0) {
                targetElements.on(
                    evt + EVENT_NAMESPACE, function elementClose(event) {
                        $.powerTip.hide(this, !isMouseEvent(event))
                    })
            }
        });
        targetElements.on(
            'keydown' + EVENT_NAMESPACE, function elementKeyDown(event) {
                if (event.keyCode === 27) {
...
function DisplayController(element, options, tipController) {
    ...
    function closeAnyDelayed() {
        if (session.delayInProgress && session.activeHover &&
...
function PlacementCalculator() {
    function computePlacementCoords(
        ...
        var placementBase = placement.split('-')[0],
            coords = new CSSCoordinates, position;
        ...
        switch (placement) {
            case 'n':
                ...
                coords.set(
                    'bottom', session.windowHeight - position.top + offset);
                break;
            case 'e':
            ...
            case 'w':
                coords.set('top', position.top - tipHeight / 2);
                coords.set(
                    'right', session.windowWidth - position.left + offset);
                break;
            case 'nw':
                coords.set(
                    'bottom', session.windowHeight - position.top + offset);
    ...
    function getHtmlPlacement(element, placement) {
        var objectOffset = element.offset(), objectWidth = element.outerWidth(),
            objectHeight = element.outerHeight(), left, top;
        switch (placement) {
            case 'n':
    ...
    function getSvgPlacement(element, placement) {
        var svgElement = element.closest('svg')[0], domElement = element[0],
        ...
        point.y -= halfHeight;
        pushPlacement();
        if (placements[0].y !== placements[1].y ||
...
function TooltipController(options) {
    ...
    if (tipElement.length === 0) {
        ...
        session.tooltips =
            session.tooltips ? session.tooltips.add(tipElement) : tipElement
    }
    ...
    function showTip(element) {
        ...
        if (!element.data(DATA_FORCEDOPEN) && !options.followMouse) {
            $document.on(
                'click' + EVENT_NAMESPACE, function documentClick(event) {
                    var target = event.target;
                    if (target !== element[0]) {
                        if (options.mouseOnToPopup) {
                            if (target !== tipElement[0] &&
        ...
        if (options.mouseOnToPopup && !options.manual) {
            tipElement.on(
                'mouseenter' + EVENT_NAMESPACE, function tipMouseEnter() {
            ...
            tipElement.on(
                'mouseleave' + EVENT_NAMESPACE, function tipMouseLeave() {
                    if (session.activeHover) {
            ...
            if (collisions !== Collision.none) {
                ...
                if (collisionCount === 1) {
                    if (collisions === Collision.right) {
                        ...
                        coords.set(
                            'top',
                            session.scrollTop + session.windowHeight -
                                tipHeight)
                    }
                } else {
                    coords.set(
                        'left', session.currentX - tipWidth - options.offset);
                    coords.set(
                        'top', session.currentY - tipHeight - options.offset)
                }
            }
            tipElement.css(coords)
        }
        ...
        if (options.smartPlacement ||
            ...
            $.each(priorityList, function(idx, pos) {
                var collisions = getViewportCollisions(
                    placeTooltip(element, pos), tipElement.outerWidth(),
    ...
    function placeTooltip(element, placement) {
        var iterationCount = 0, tipWidth, tipHeight,
            coords = new CSSCoordinates;
        coords.set('top', 0);
        coords.set('left', 0);
        tipElement.css(coords);
        do {
            ...
            coords = placementCalculator.compute(
                element, placement, tipWidth, tipHeight, options.offset);
            tipElement.css(coords)
    ...
    function closeDesyncedTip() {
        ...
        if (session.isTipOpen && !session.isClosing &&
            !session.delayInProgress && hasDesyncableCloseEvent) {
            if (session.activeHover.data(DATA_HASACTIVEHOVER) === false ||
...
function isMouseEvent(event) {
    return Boolean(
        event && $.inArray(event.type, MOUSE_EVENTS) > -1 &&
...
function getViewportCollisions(coords, elementWidth, elementHeight) {
    ...
    if (coords.left < viewportLeft ||
        coords.right + elementWidth > viewportRight) {
        collisions |= Collision.left
    }
    if (coords.left + elementWidth > viewportRight ||
...
!function(a) {
    function f(a, b) {
        if (!(a.originalEvent.touches.length > 1)) {
            ...
            d.initMouseEvent(
                b, !0, !0, window, 1, c.screenX, c.screenY, c.clientX,
                c.clientY, !1, !1, !1, !1, 0, null),
    ...
    if (a.support.touch = 'ontouchend' in document, a.support.touch) {
        ...
        b._touchStart = function(a) {
            ...
            !e && b._mouseCapture(a.originalEvent.changedTouches[0]) &&
                (e = !0, b._touchMoved = !1, f(a, 'mouseover'),
                 f(a, 'mousemove'), f(a, 'mousedown'))
        }, b._touchMove = function(a) {
            e && (this._touchMoved = !0, f(a, 'mousemove'))
        }, b._touchEnd = function(a) {
            e &&
                (f(a, 'mouseup'), f(a, 'mouseout'),
                 this._touchMoved || f(a, 'click'), e = !1)
        ...
        var i = !0, s = null, o = {
            mousemove: function(t) {
                ...
                if (s) {
                    ...
                    if ((o > 0 || a > 0) && 2 >= o && 2 >= a &&
                        300 >= e.timeStamp - s.timeStamp && (mouse = !0, i)) {
...
var menuTrees = [], mouse = !1, touchEvents = 'ontouchstart' in window,
...
return $.SmartMenus =
           function(t, e) {
    this.$root = $(t), this.opts = e, this.rootId = '',
    this.accessIdPrefix = '', this.$subArrow = null, this.activatedItems = [],
    this.visibleSubMenus = [], this.showTimeout = 0, this.hideTimeout = 0,
    this.scrollTimeout = 0, this.clickActivated = !1, this.focusActivated = !1,
    this.zIndexInc = 0, this.idInc = 0, this.$firstLink = null,
    this.$firstSub = null, this.disabled = !1, this.$disableOverlay = null,
    ...
    this.wasCollapsible = !1, this.init()
       ...
       $.extend($.SmartMenus, {
           ...
           prototype: {
               init: function(t) {
                   ...
                   if (!t) {
                       menuTrees.push(this),
                           this.rootId = ((new Date).getTime() + Math.random() +
                                          '').replace(/\D/g, ''),
                           ...
                           (t == a || t == n) &&
                               (i.addClass('current'),
                                e.opts.markCurrentTree &&
                                    i.parentsUntil('[data-smartmenus-id]', 'ul')
                                        .each(function() {
                                            $(this)
                                                .dataSM('parent-a')
                                                .addClass('current')
               ...
               destroy: function(t) {
                   ...
                   this.$root.find('ul')
                       ...
                       t ||
                       (this.$root = null, this.$firstLink = null,
                        this.$firstSub = null,
                        this.$disableOverlay &&
                   ...
                   if (this.lastTouch) {
                       if (!(!this.visibleSubMenus.length ||
                             ...
                             this.lastTouch.target &&
                                 $.contains(
                                     this.$root[0], this.lastTouch.target))) {
                           this.hideTimeout &&
               ...
               getStartZIndex: function(t) {
                   var e =
                       parseInt(this[t ? '$root' : '$firstSub'].css('z-index'));
                   return !t && isNaN(e) &&
               ...
               isTouchMode: function() {
                   return !mouse || this.opts.noMouseOver ||
                       this.isCollapsible()
               },
               itemActivate: function(t, e) {
                   ...
                   if ((!this.isCollapsible() || e) &&
                       ...
                       var a = t.dataSM('sub');
                       a &&
                           (this.isTouchMode() || !this.opts.showOnClick ||
                            this.clickActivated) &&
                           this.menuShow(a)
                   }
               },
                   ...
                   if (this.handleItemEvents(e)) {
                       if (this.$touchScrollingSub &&
                           ...
                           return this.$touchScrollingSub = null,
                                  t.stopPropagation(), !1;
                       if (this.$root.triggerHandler('click.smapi', e[0]) ===
                           !1)
                           return !1;
                       ...
                       if (s && !s.is(':visible')) {
                           if ((!r || !a || i) &&
                               (this.opts.showOnClick && o &&
                                ...
                                this.itemActivate(e, h), s.is(':visible')))
                               return this.focusActivated = !0, !1
                       } else if (a && (n || i))
                           return this.itemActivate(e, h), this.menuHide(s),
                                  n && (this.focusActivated = !1), !1;
                   ...
                   this.handleItemEvents(e) &&
                       (!this.focusActivated ||
                            ...
                            this.activatedItems.length &&
                                this.activatedItems
                                        [this.activatedItems.length - 1][0] ==
                                    e[0] ||
               ...
               menuHide: function(t) {
                   if (this.$root.triggerHandler('beforehide.smapi', t[0]) !==
                           !1 &&
                       ...
                       this.activatedItems.splice(i - 1, 1),
                           this.visibleSubMenus.splice(
                               $.inArray(t, this.visibleSubMenus), 1),
               ...
               menuHideAll: function() {
                   ...
                   for (var t = this.opts.isPopup ? 1 : 0,
                   ...
                   this.opts.isPopup &&
                       ...
                       this.activatedItems = [], this.visibleSubMenus = [],
                       this.clickActivated = !1, this.focusActivated = !1,
                       this.zIndexInc = 0,
               ...
               menuPosition: function(t) {
                   var e, i, s = t.dataSM('parent-a'), o = s.closest('li'),
                             a = o.parent(), n = t.dataSM('level'),
                             r = this.getWidth(t), h = this.getHeight(t),
                             u = s.offset(), l = u.left, c = u.top,
                             d = this.getWidth(s), m = this.getHeight(s),
                             p = $(window), f = p.scrollLeft(),
                             v = p.scrollTop(), b = this.getViewportWidth(),
                             S = this.getViewportHeight(),
                             g = a.parent().is('[data-sm-horizontal-sub]') ||
                       2 == n && !a.hasClass('sm-vertical'),
                             M = this.opts.rightToLeftSubMenus &&
                           !o.is('[data-sm-reverse]') ||
                       !this.opts.rightToLeftSubMenus &&
                           o.is('[data-sm-reverse]'),
                             w = 2 == n ? this.opts.mainMenuSubOffsetX :
                                          this.opts.subMenusSubOffsetX,
                             T = 2 == n ? this.opts.mainMenuSubOffsetY :
                                          this.opts.subMenusSubOffsetY;
                   if (g ? (e = M ? d - r - w : w,
                            i = this.opts.bottomToTopSubMenus ? -h - T :
                                                                m + T) :
                           (e = M ? w - r : d - w,
                            i = this.opts.bottomToTopSubMenus ? m - T - h : T),
                       this.opts.keepInViewport) {
                       var y = l + e, I = c + i;
                       if (M && f > y ? e = g ? f - y + e : d - w :
                                        !M && y + r > f + b &&
                                   (e = g ? f + b - r - y + e : w - r),
                           g ||
                               (S > h && I + h > v + S ?
                           ...
                           if (t.dataSM('scroll', {
                                   ...
                                   .eq(g && this.opts.bottomToTopSubMenus ? 0 :
                                                                            1)
                                   .show(),
                               this.isFixed()) {
                               var C = {};
               ...
               menuScroll: function(t, e, i) {
                   var s, o = t.dataSM('scroll'), a = t.dataSM('scroll-arrows'),
                   ...
                   if (this.activatedItems[r - 1] &&
                           this.activatedItems[r - 1].dataSM('sub') &&
                           this.activatedItems[r - 1].dataSM('sub').is(
                               ':visible') &&
                       ...
                       this.opts.scrollAccelerate &&
                           o.step < this.opts.scrollStep && (o.step += .2);
                       var h = this;
               ...
               menuScrollOver: function(t, e) {
                   if (mouse && !/^scroll-(up|down)/.test(e.target.className) &&
                       this.getClosestMenu(e.target) == t[0]) {
                       this.menuScrollRefreshData(t);
                       var i = t.dataSM('scroll'),
                           s = $(window).scrollTop() -
                           t.dataSM('parent-a').offset().top - i.itemH;
                       t.dataSM('scroll-arrows')
                           .eq(0)
                           .css('margin-top', s)
                           .end()
               ...
               menuScrollRefreshData: function(t) {
                   var e = t.dataSM('scroll'),
                       i = $(window).scrollTop() -
                       t.dataSM('parent-a').offset().top - e.itemH;
                   this.cssTransforms3d &&
               ...
               menuScrollStop: function(t) {
                   return this.scrollTimeout ?
                       (cancelAnimationFrame(this.scrollTimeout),
                        this.scrollTimeout = 0, t.dataSM('scroll').step = 1,
                        !0) :
                       void 0
               },
                       ...
                       if (this.getClosestMenu(i.target) == t[0]) {
                           ...
                           if (/(start|down)$/i.test(e.type))
                               this.menuScrollStop(t) ?
                                   ...
                                   this.$touchScrollingSub = null,
                                   this.menuScrollRefreshData(t), $.extend(s, {
                                       touchStartY: i.pageY,
                                       touchStartTime: e.timeStamp
                                   });
                           else if (/move$/i.test(e.type)) {
                               var o = void 0 !== s.touchY ? s.touchY :
                                                             s.touchStartY;
               ...
               menuShow: function(t) {
                   if ((t.dataSM('beforefirstshowfired') ||
                       ...
                       if ((this.opts.keepHighlighted || i) &&
               ...
               rootOut: function(t) {
                   if (this.handleEvents() && !this.isTouchMode() &&
               ...
               rootOver: function(t) {
                   this.handleEvents() && !this.isTouchMode() &&
                       t.target != this.$root[0] && this.hideTimeout &&
                       (clearTimeout(this.hideTimeout), this.hideTimeout = 0)
               },
       ...
       $.fn.dataSM =
           function(t, e) {
           return e ? this.data(t + '_smartmenus', e) :
